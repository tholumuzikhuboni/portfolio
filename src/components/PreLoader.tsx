      ...
      <div className="relative flex flex-col items-center">
        ...
        >
          <div className="relative flex items-center justify-center w-24 h-24 mb-2">
            ...
            <div className="relative">
              <Code className="h-10 w-10 text-code-purple" />
              <Sparkles className="absolute -top-1 -right-1 h-4 w-4 text-code-green animate-pulse" />
            </div>
          </div>
          
          <span className="flex justify-center items-center gap-2 font-mono font-medium text-xl md:text-2xl gradient-text">
        ...
        <div className="w-64 md:w-80 space-y-2">
          ...
          <div className="flex justify-between items-center text-xs font-mono">
            ...
            <span className="text-code-purple">{progress}%</span>
          </div>
        </div>
        
        <div className="mt-8 text-xs md:text-sm font-mono text-foreground/70 bg-white/5 backdrop-blur-sm rounded-md px-4 py-2 border border-white/10">
