  ...
  return (
    <section className="min-h-screen pt-24 pb-16 flex flex-col justify-center relative overflow-hidden">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        {/* Additional animated code symbols for more depth */}
        <div className="absolute top-[18%] left-[45%] text-code-yellow/20 font-mono text-xl animate-float" style={{ animationDuration: '5.5s', animationDelay: '0.7s' }}>{'if()'}</div>
        <div className="absolute bottom-[45%] right-[25%] text-code-green/20 font-mono text-xl animate-float" style={{ animationDuration: '6.5s', animationDelay: '1.2s' }}>{'==='}</div>
        ...
        <div className="absolute bottom-[60%] left-[50%] text-code-pink/20 font-mono text-xl animate-float" style={{ animationDuration: '6.8s', animationDelay: '2.2s' }}>{'return'}</div>
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="max-w-7xl mx-auto w-full px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"
      >
        <div className="space-y-8">
          ...
          >
            ...
            >
              <Link 
                to="/projects"
                className="group bg-gradient-to-r from-code-blue to-code-purple text-white py-3 px-6 rounded-md font-medium transition-all duration-300 hover:shadow-lg flex items-center gap-2 whitespace-nowrap text-base sm:text-lg"
              >
            ...
            >
              <Link 
                to="/contact"
                className="group border-2 border-code-purple/30 bg-background/80 backdrop-blur-sm text-foreground py-3 px-6 rounded-md font-medium transition-all duration-300 hover:bg-code-purple/5 hover:border-code-purple/70 flex items-center gap-2 whitespace-nowrap text-base sm:text-lg"
              >
          ...
          >
            <motion.a 
              ...
              className="bg-[#333] hover:bg-[#24292E] text-white rounded-full p-2.5 transition-all hover:scale-110 active:scale-95 flex items-center justify-center w-12 h-12 shadow-lg"
            ...
            <motion.a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-[#0A66C2] hover:bg-[#004182] text-white rounded-full p-2.5 transition-all hover:scale-110 active:scale-95 flex items-center justify-center w-12 h-12 shadow-lg"
              whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-gradient-to-br from-[#E4405F] to-[#C13584] hover:from-[#D93B57] hover:to-[#B52F7C] text-white rounded-full p-2.5 transition-all hover:scale-110 active:scale-95 flex items-center justify-center w-12 h-12 shadow-lg"
              whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-[#1877F2] hover:bg-[#0E5FCF] text-white rounded-full p-2.5 transition-all hover:scale-110 active:scale-95 flex items-center justify-center w-12 h-12 shadow-lg"
              whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" }}
              whileTap={{ scale: 0.95 }}
            >
        ...
        <motion.div
          variants={itemVariants}
          className="w-full max-w-xl mx-auto lg:mx-0 relative perspective-1000"
        >
          <div className="absolute -top-4 -left-4 w-8 h-8 border-t-2 border-l-2 border-code-blue/30 rounded-tl-lg z-10"></div>
          <div className="absolute -bottom-4 -right-4 w-8 h-8 border-b-2 border-r-2 border-code-purple/30 rounded-br-lg z-10"></div>
          
          <div className="absolute -top-6 right-6 bg-code-green/10 p-1 rounded text-xs font-mono text-code-green border border-code-green/20 animate-float z-10" style={{ animation: 'float 3s ease-in-out infinite' }}>
          ...
          >
            {isVisible && <CodeBlock code={code} className="shadow-2xl transform transition-all duration-500 hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.2)]" />}
          </motion.div>
          
          <div className="absolute -bottom-2 -left-2 w-4 h-4 rounded-full bg-code-yellow/20 z-0"></div>
          <div className="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-code-green/20 z-0"></div>
          <div className="absolute bottom-10 -right-4 w-3 h-3 rounded-full bg-code-blue/20 z-0"></div>
          <div className="absolute top-10 -left-4 w-3 h-3 rounded-full bg-code-purple/20 z-0"></div>

          {/* Additional decorative elements */}
          <motion.div 
            className="absolute -bottom-8 left-20 text-code-purple/30 z-0"
            animate={{ rotate: 360 }} 
          ...
          <motion.div 
            className="absolute -top-8 right-20 text-code-green/30 z-0"
            animate={{ rotate: -360 }} 
            transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
          >
            <Terminal size={28} />
